...
import { CreateVideos1782841224990 } from './migrations/1782841224990-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    // Serial, FK-safe teardown — parallel CASCADE drops deadlock once the
    // videos→channels FK is in play. Enum types are dropped too so a fresh
    // runMigrations can recreate them regardless of prior DB state.
